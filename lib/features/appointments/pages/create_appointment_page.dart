...
// ─── Novo modelo de agenda (paridade com CreateAppointmentPage do web) ───────
...
class _CreateAppointmentPageState extends State<CreateAppointmentPage> {
  ...
  Widget _buildVisibilityList(ThemeData theme) {
    // Paridade web: só Particular (private) e Pública (public) — sem "Equipe".
    const options = [
