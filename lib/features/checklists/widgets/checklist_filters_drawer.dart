...
/// Bottom-sheet de filtros dos Checklists — espelha o padrão do
/// `kanban_filters_drawer.dart`: seções *flush* separadas por filete
/// tracejado + eyebrow com dot de cor; chips com tint (nunca sólido).
class ChecklistFiltersDrawer extends StatefulWidget {
  final ChecklistType? initialType;
  final ChecklistStatus? initialStatus;
  final void Function(ChecklistType? type, ChecklistStatus? status) onApply;
  final VoidCallback onClear;

  const ChecklistFiltersDrawer({
    super.key,
    this.initialType,
    this.initialStatus,
  ...
  @override
  State<ChecklistFiltersDrawer> createState() => _ChecklistFiltersDrawerState();
}

class _ChecklistFiltersDrawerState extends State<ChecklistFiltersDrawer> {
  ChecklistType? _type;
  ...
  int get _activeCount => (_type != null ? 1 : 0) + (_status != null ? 1 : 0);
                ...
                child: ListView(
                  ...
                  children: [
                    _section(
                      ...
                      accent: cTipo,
                      label: 'Tipo',
                      hint: 'Processo de venda ou de aluguel.',
                      first: true,
                      child: Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: [
                          ...
                          _ChipChoice(
                            ...
                            selected: _type == ChecklistType.sale,
                            accent: cTipo,
                            onTap: () =>
                                setState(() => _type = ChecklistType.sale),
                          ),
                          _ChipChoice(
                            label: 'Aluguel',
                            icon: LucideIcons.key,
                            selected: _type == ChecklistType.rental,
                            accent: cTipo,
                            onTap: () =>
                                setState(() => _type = ChecklistType.rental),
                          ),
                        ],
                      ),
                    ),
                    _section(
                      ...
                      accent: cStatus,
                      label: 'Status',
                      hint: 'Estágio atual do checklist.',
                      child: Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: [
